...
/*
Package cinkstone is a reverse proxy.
...
func request_AppService_GetVersion_0(ctx context.Context, marshaler runtime.Marshaler, client AppServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterAppServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AppServiceClient) error {
	...
	mux.Handle("GET", pattern_AppService_GetVersion_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AppService_GetVersion_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_AppService_GetVersion_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_AppService_GetVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "version"}, ""))
)

var (
	forward_AppService_GetVersion_0 = runtime.ForwardResponseMessage
)
